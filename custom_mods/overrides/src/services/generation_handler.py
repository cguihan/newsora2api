...
class GenerationHandler:
    ...
    def _get_required_sora2_remaining(self, model_config: Dict[str, Any]) -> int:
        """Get required Sora2 remaining count for the model."""
        if model_config.get("type") != "video":
            return 1
        n_frames = model_config.get("n_frames", 0)
        return 2 if n_frames >= 450 else 1
